 ...
 * @since 2.1
 *
 * @uses do_action Calls 'wpmem_pwd_change' action at successful user password change
 *
 * @global $user_ID
 ...
 * @uses   do_action     Calls 'wpmem_pwd_reset' action at successful user password reset
